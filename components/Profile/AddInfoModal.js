      ...
      <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === "ios" ? "padding" : null} enabled>
        <View style={styles.inner}>
          <Modal
            ...
            <View style={styles.inner}>
              <View>
                <Text id='addInfoModalHeaderText' style={styles.appText}>You can add your Address and Phone Number
                  below.</Text>
                ...
                <Formik initialValues={{address: '', phoneNumber: ''}}
                  ...
                  {({
                    ...
                    <View>
                      <TextInput id='addInfoAddressTextInput'
                                 theme={theme}
                                 placeholder="Address"
                      ...
                      <TextInput id='addInfoPhoneNumberTextInput'
                                 theme={theme}
                      ...
                      {modalSuccessTextVisible ?
                        <Text style={styles.appText}>Successfully added your details. Press close to return to you
                          profile.</Text>
                        : undefined}
                    </View>
                  )}
